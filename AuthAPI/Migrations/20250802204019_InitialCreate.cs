        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValorDebe = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ValorHaber = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SaldoValor = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Existencias = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovimientosPieza", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovimientosPieza_Piezas_PiezaId",
                        column: x => x.PiezaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComponentesProducto", x => new { x.ProductoId, x.PiezaId });
                    table.ForeignKey(
                        name: "FK_ComponentesProducto_Piezas_PiezaId",
                        column: x => x.PiezaId,
                        principalTable: "Piezas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlDocumento = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Manuales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Manuales_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MovimientosPiezaId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DetalleCompra_MovimientosPieza_MovimientosPiezaId",
                        column: x => x.MovimientosPiezaId,
                        principalTable: "MovimientosPieza",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComponentesProducto_PiezaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleCompra_MovimientosPiezaId",
                table: "DetalleCompra",
                column: "MovimientosPiezaId",
                unique: true);
