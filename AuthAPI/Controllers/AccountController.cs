...
namespace AuthAPI.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordDto forgotPasswordDto)
        {
            ...
            //            request.AddHeader("Authorization", "Bearer 8de3ccb326c330b147263e57e9848799");
            //            request.AddHeader("Content-Type", "application/json");
            //            request.AddParameter("application/json", "{\"from\":{\"email\":\"hello@demomailtrap.co\",\"name\":\"Mailtrap Test\"},\"to\":[{\"email\":\"zurielmora3@gmail.com\"}],\"template_uuid\":\"e45c0f0c-bb80-4e1a-aec7-c5504765de4e\",\"template_variables\":{\"user_email\":\"Test_User_email\",\"pass_reset_link\":\"Test_Pass_reset_link\"}}", ParameterType.RequestBody);
            ...
            request.AddJsonBody(new
            {
                ...
                template_uuid = "e45c0f0c-bb80-4e1a-aec7-c5504765de4e",
            ...
            if (response.IsSuccessful)
            {
                ...
                {
                    IsSuccess = true,
                    Message = "Email sent with password reset link. Please chech your email."
                });
            }
            else
            {
